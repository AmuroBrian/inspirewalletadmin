...
const Notifications = () => {
  ...
  const [isSending, setIsSending] = useState(false); // Track notification sending state
  ...
  if (isSending) {
    return (<div className="flex flex-col justify-center items-center min-h-screen bg-white relative overflow-hidden">
      <motion.div
        animate={{ x: ["100%", "-100%"] }}
